            ...
            <header> <!-- Defining the header section of the page with the appropriate tag -->
                ...
                <nav class="clear" id="mainmenu"> <!-- The nav link semantically marks your main site navigation -->
						<?php $this->widget('zii.widgets.CMenu',array(
							'items'=>array(
								array('label'=>'topic1', 'url'=>array('/topic1/admin')),
								array('label'=>'topic2', 'url'=>array('/topic2/admin')),
                                array('label'=>'topic3', 'url'=>array('/topic3/admin')),
                                array('label'=>'Document', 'url'=>array('/document/admin')),
